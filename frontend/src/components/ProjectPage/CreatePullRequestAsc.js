...
class CreatePullRequestAsc extends Component {
  ...
  createPullRequest() {
    let checksumRewardeeAddress = toChecksumAddress(
    ...
    const toastId = toast.info(
      <div>
        ...
        <p>
          This could take a few minutes while your proposal is added to the
          Ethereum blockchain. Now might be a good time to get a coffee &nbsp;
    ...
    return (
      <div className="Modal">
        ...
        <div className="Body">
          ...
          />
          <h3>
            Reward in <em>{this.props.symbol}</em>:
          </h3>
          <input
