...
class Project extends Component {
    ...
    return {
      ...
      joyrideSteps: [
        ...
        },
        {
          target: '#repo-summary',
          content:
            "This is where you can find summary information about the repo like it's blockchain address, it's symbol and a link to it's GitHub repository.",
          placement: 'bottom'
        },
        {
          target: '#dao-balances',
          content:
            'This is where you can find token distribution information for the project. You can see who owns how many coins.',
          placement: 'bottom'
        },
        {
          target: '#asc-list',
        ...
        },
        {
          ...
          content:
            "This is how you can create your own proposals which we'll submit to the blockchain.",
          placement: 'bottom'
        }
      ]
    };
  ...
  renderBalanceBlock(balances) {
      ...
      return (
        <div key={account.address}>
          <span
            ...
            style={{ backgroundColor: colors[index % colors.length].lowlight }}
          />
    ...
    return (
      <div className="InfoBlock" id="dao-balances">
        ...
        <div className="InfoBody BalanceBlockBody">
          ...
          <div className="BalanceListWrapper">{balancesList}</div>
        </div>
      </div>
    );
  }
  ...
  renderAscList(project, ascs) {
    let userBalance = project.balances.find(
      balance =>
        balance.address === toChecksumAddress(window.web3.eth.accounts[0])
    );
    if (userBalance) {
  ...
  renderAllAscs(project) {
    ...
    const openAscsList = openAscs.length ? (
      this.renderAscList(project, openAscs)
    ) : (
      <h3>No Pull Request Proposals are open</h3>
    );
    const completedAscsList = completedAscs.length ? (
      this.renderAscList(project, completedAscs)
    ) : (
    ...
    return (
      <div className="Ascs" id="asc-list">
        {content}
      </div>
    );
  }
      ...
      <div className="Page">
        <div className="PanelContainer">
              ...
              <div className="InfoBody">
                ...
                <div className="InfoLine">
                  ...
                  <span className="Value">
                    <AddressShortener address={project.daoAddress} />
                  </span>
                </div>
                <div className="InfoLine">
                ...
                <a href={project.url} target="blank_">
                  View Github Project <span className="GitHubLogo" />
                </a>
              </div>
            </div>
          ...
          <div className="RightPanel">
            ...
            >
              <a style={closeStyle} onClick={this.closeAscModal.bind(this)}>
                X
              </a>
